...
int main() {
    ...
    animals.push_back(new Fish("Bass", 2, "River", false, false));
    animals.push_back(new Fish("Salmon", 5, "Ocean", true, false));
    animals.push_back(new Fish("Cat fish", 1, "Coral Reef", true, true));

    animals.push_back(new Bird("Golden eagle", 10, "Mountains", true, false));
    animals.push_back(new Bird("Penguin", 3, "Antarctica", false, false));
    animals.push_back(new Bird("Crane", 7, "Savannah", true, true));

    animals.push_back(new Mammal("Panther", 8, "Savannah", true, true));
    animals.push_back(new Mammal("Whale", 4, "Ocean", false, true));
    animals.push_back(new Mammal("Llama", 6, "South America", true, false));
